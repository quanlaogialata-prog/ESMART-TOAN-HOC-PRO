...
let content = "Ta có (2x - 1)(x + 3) = 0 \\Leftrightarrow $$\\begin{bmatrix} 2x - 1 = 0 \\n x + 3 = 0 \\end{bmatrix}$$ \\Leftrightarrow \\begin{bmatrix} x = \\frac{1}{2} \\n x = -3 \\end{bmatrix}. Vậy nghiệm của phương trình là x = \\frac{1}{2}; x = -3. Chọn B.";
